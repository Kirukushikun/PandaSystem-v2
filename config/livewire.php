...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Default 12MB is far below Backups::openRestore()'s own max:512000 (500MB) validation
        // for restore .sql/.zip uploads — real backups exceed 12MB easily, so raised to match.
        'rules' => ['required', 'file', 'max:512000'],        // 500MB, matches Backups.php's restoreFile rule
        ...
        'max_upload_time' => 15, // Bumped from 5 — large restore uploads need more headroom on slower connections.
