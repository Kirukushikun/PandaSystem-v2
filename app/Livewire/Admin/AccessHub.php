 ...
 * Its own page (routed, not a modal — needs the room), reachable ONLY via the
 * "Sync from Hub" link on User Accounts — deliberately no sidebar nav entry of
 * its own, so it never reads as a permanent module alongside User Access/Maintenance.
 */
#[Layout('layouts.app')]
